...
var _IndexSchema = require("./IndexSchema");

var _IndexSchema2 = _interopRequireDefault(_IndexSchema);
...
function ObjectStoreSchema(storeName) {
  ...
  var autoIncrement = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];

  _classCallCheck(this, ObjectStoreSchema);

  for (var _len = arguments.length, indexes = Array(_len > 3 ? _len - 3 : 0), _key = 3; _key < _len; _key++) {
    indexes[_key - 3] = arguments[_key];
  }

  var duplicateNames = (0, _validation.getDuplicateNames)(indexes);
...
exports.default = ObjectStoreSchema;