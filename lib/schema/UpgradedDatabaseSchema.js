...
var UpgradedDatabaseSchema = function () {
  _createClass(UpgradedDatabaseSchema, null, [{
    key: "SKIP_RECORD",
  ...
  function UpgradedDatabaseSchema(version, fetchBefore, objectStores) {
    var after = arguments.length <= 3 || arguments[3] === undefined ? function () {} : arguments[3];

    _classCallCheck(this, UpgradedDatabaseSchema);
  ...
  return UpgradedDatabaseSchema;
}();

exports.default = UpgradedDatabaseSchema;